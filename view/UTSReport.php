        ...
        <div class="main">
            <div class="col span_2_of_4">
                <div class="adddata-form">
                    <h2 class="style" align="center">Data Informasi Siswa untuk Semester 1 (Ganjil)</h2>
                    <form method="post" action="PDF/UTSReport.php" >
                        <div>
                        ...
                        <div>
                            <div><input type="submit" name="submit" value="Print Raport Semester 1 (Ganjil)" ></div>
                        </div>
                    </form>
                </div>
            </div>
